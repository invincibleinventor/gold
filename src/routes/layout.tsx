...
export default component$(() => {
 ...
 <div class=" min-h-screen lg:min-h-[calc(100vh-128px)] w-full  bg-blue-200 lg:bg-opacity-10 border border-sky-700  lg:filter lg:backdrop-blur-md lg:backdrop-blur-lg md:shadow-2xl md:rounded-[30px] mx-auto pb-10 lg:pb-20 xl:pb-0">
