...
export default component$(() => {
    ...
    <a href="/events" class="lg:mx-0 mx-6 bg-white shadow-2xl font-medium lg:font-semibold font-poppins text-blue-900 px-10 mt-3 mb-3 block lg:hidden lg:mt-0 transition-all ease-linear duration-100 hover:scale-105 py-3 rounded-md text-lg text-center"><span class="mx-auto">View Events</span></a>
