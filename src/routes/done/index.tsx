...
export default component$(()=>{
    return(
        ...
        <button class="bg-white shadow-2xl mx-auto font-semibold font-poppins text-blue-900 px-10 transition-all ease-linear duration-100 hover:scale-105 py-3 rounded-md text-lg" onClick$={()=>window.location.replace('/scan')}>Go Back</button>
    </div>
    )
})