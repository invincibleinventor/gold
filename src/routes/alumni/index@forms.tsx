...
{/* 
  ...
  let btn="Register Now" ,title="TTS ATA - Alumni Meet",desc="Register for the Alumni meet - a part of the 2023 Swarnotsav celebrations ",willing,school,name='',gender,wa,ph,year,number
