...
<div class="absolute bottom-0 right-0 left-0 w-full h-[265px] lg:h-[295px] bg-sky-900 lg:bg-blue-900 border border-blue-800 lg:border-none  bg-opacity-90 filter backdrop-blur-lg rounded-t-xl lg:rounded-t-2xl shadow-2xl rounded-b-xl px-0 py-8 pb-0 ">
