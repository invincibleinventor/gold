...
<div class={`${state.hidden?'hidden':''} shadow-2xl absolute top-[60px] rounded-t-none w-[calc(100vw-30px)] mx-auto left-0 right-0 bg-indigo-900 py-2 rounded-lg z-[10] py-2 px-[30px] flex flex-col`}>
<div class="py-4 pt-0">
