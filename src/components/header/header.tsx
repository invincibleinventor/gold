...
export default component$(() => {
  ...
  return (
   <div  class="bg-indigo-900 absolute w-[calc(100vw-30px)] shadow-2xl rounded-b-none z-[100]   rounded-lg flex flex-row m-4 py-4 px-7 items-center content-center ">
...
<div class={`${state.hidden?'hidden':''} shadow-2xl absolute top-[60px] rounded-t-none w-[calc(100vw-30px)] mx-auto left-0 right-0 bg-indigo-900 py-2 rounded-lg z-[10] py-0 px-8 flex flex-col`}>
<div class="py-4 pt-0">
...
<div class="py-4">
  <a href="/registration" class="text-white text-lg font-semibold opacity-80">Registration</a>
</div>
